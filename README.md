...
- `feature/sport` – upravljanje šifarnikom sportova (kreiranje, izmena i brisanje sportskih kategorija)
- `feature/teren` – upravljanje terenima (kreiranje, izmena, radno vreme, dostupni sportovi po terenu)
